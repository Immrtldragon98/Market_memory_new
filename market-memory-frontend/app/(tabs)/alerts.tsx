...
const s=StyleSheet.create({page:{flex:1,backgroundColor:theme.colors.bg},content:{padding:16,maxWidth:880,width:'100%',alignSelf:'center'},kicker:{color:theme.colors.primary,fontSize:11,fontWeight:'900'},title:{color:theme.colors.text,fontSize:30,fontWeight:'900'},sub:{color:theme.colors.textMuted,marginVertical:12,lineHeight:20},stats:{flexDirection:'row',gap:10,marginBottom:12},stat:{flex:1,backgroundColor:theme.colors.panel,borderWidth:1,borderColor:theme.colors.border,borderRadius:12,padding:16},statValue:{color:theme.colors.text,fontSize:24,fontWeight:'900'},statLabel:{color:theme.colors.textDim,marginTop:2},checkBtn:{backgroundColor:theme.colors.primaryStrong,padding:14,borderRadius:10,alignItems:'center'},btn:{color:'#fff',fontWeight:'800'},hint:{color:theme.colors.textDim,fontSize:12,marginTop:10},heading:{color:theme.colors.text,fontSize:18,fontWeight:'800',marginVertical:18},empty:{color:theme.colors.textDim},card:{backgroundColor:theme.colors.panel,borderWidth:1,borderColor:theme.colors.border,borderRadius:12,padding:16,marginBottom:10,flexDirection:'row',justifyContent:'space-between',gap:12},triggeredCard:{borderColor:'#166534'},main:{flex:1},row:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},symbol:{color:theme.colors.primary,fontWeight:'900',fontSize:17},status:{fontSize:10,fontWeight:'900'},active:{color:'#fbbf24'},triggered:{color:'#4ade80'},body:{color:theme.colors.textMuted,marginTop:6},meta:{color:theme.colors.textDim,fontSize:11,marginTop:8},triggerText:{color:'#4ade80',fontSize:11,marginTop:4,fontWeight:'700'},remove:{color:'#f87171',fontWeight:'700'}});
